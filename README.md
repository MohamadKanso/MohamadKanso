...
**`> DATA_&_CLOUD_ENGINEERING`** <br>
*Azure Data Factory / Databricks / MLflow* <br>
Processing tens of millions of records daily for public-sector (HMRC) analytics. Reduced downstream modelling latency by 40% via optimized pipeline standardisation.

<br>

**`> LOCAL_GEN_AI_SYSTEMS`** <br>
*Hugging Face / Whisper.cpp / Qwen* <br>
Architecting privacy-first, local LLM pipelines demonstrating 80% cost-reductions vs paid APIs while maintaining sub-2s inference latency.

<br>

**`> TIME_SERIES_&_ML`** <br>
*LSTM / Scikit-Learn / PyTorch* <br>
Deploying robust feature engineering and regression models (AUC 0.92) designed for strict research-grade reproducibility and realistic operational constraints.
...
<pre><code>[LANG]   Python, SQL, Bash
[DATA]   PySpark, Pandas, NumPy
[CLOUD]  Azure DF, Databricks
[AI/ML]  HF, Scikit-Learn, PyTorch
[NVRAM]  Vector DBs, PostgreSQL
[ops]    Docker, Git, CI/CD
</code></pre>

### `[ 03: HARDWARE_DIAGNOSTICS ]`

<pre><code>ACADEMIC: MSci Data Science (2:1)*
          *First-Class Diss.
AWARDS  : Cognizant Hackathon (Win)
AWARDS  : CV Challenge (Winner)
AWARDS  : UKMT Senior Math (Silver)
</code></pre>
